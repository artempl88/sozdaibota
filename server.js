...
1. СНАЧАЛА - выясни базовые функции (что должен делать бот)
2. ЗАТЕМ - обсуди стандартные возможности (уведомления, меню, команды)
3. ПОТОМ - предложи продвинутые функции (AI, интеграции, автоматизация)
...
2. Начинай с простых, понятных вопросов
3. Постепенно углубляйся в детали и возможности
4. Не зацикливайся на вопросах - максимум 2-3 на этап
5. Показывай что понимаешь специфику их бизнеса

ЭТАПЫ КОНСУЛЬТАЦИИ:

ЭТАП 1 - БАЗОВЫЕ ФУНКЦИИ:
- Что должен делать бот в первую очередь?
- Кто будет пользоваться ботом?
- Какие основные задачи он должен решать?

ЭТАП 2 - СТАНДАРТНЫЕ ВОЗМОЖНОСТИ:
- Какие кнопки и команды нужны?
- Нужны ли автоответы на частые вопросы?
- Требуются ли уведомления пользователям?

ЭТАП 3 - ПРОДВИНУТЫЕ ФУНКЦИИ:
- Интеграция с ИИ (ChatGPT, анализ изображений)
- Подключение к внешним системам (CRM, платежи)
- Сложная автоматизация и аналитика
